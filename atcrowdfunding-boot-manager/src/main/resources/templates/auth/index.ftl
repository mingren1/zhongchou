            		...
            		success:function(result){
            			if(result.success){
            				...
            				$.each(list,function(i,e){ // i表示当前元素索引，e表示当前对象
            					...
            					content+='  <td>';
            					content+='	  <button type="button" onclick="window.location.href=\'${APP_PATH}/auth/view/'+e.memberId+'/'+e.taskId+'\'" class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></button>';
