 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form id="uploadCertForm" style="margin-top:20px;" action="${APP_PATH}/member/uploadCertFile" method="post" enctype="multipart/form-data">
		   <#list certList as cert>
			  <div class="form-group">
				<label for="${cert.name}">${cert.name}</label>
				
				<input type="hidden" name="certList[${cert_index}].certid" value="${cert.id}" class="form-control" >
				<input type="file" name="certList[${cert_index}].certfile" class="form-control" >
	            <br>
